...
| Named locks, direct LLM/Gemini proxy routes | — | — | No per-resource rule exists: any app member may call them. Prefer a managed prompt (which is gated) over the LLM proxy routes. |
